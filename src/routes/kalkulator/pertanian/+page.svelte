		...
		<Card class="p-8">
			<form class="space-y-6">
				...
				<fieldset>
					...
					<div class="flex gap-4">
						<label class="flex items-center gap-2 cursor-pointer">
							<input type="radio" name="metode" class="w-4 h-4 text-primary-500" value="irigasi" checked />
							<span class="text-white">Irigasi (5%)</span>
						</label>
						<label class="flex items-center gap-2 cursor-pointer">
							<input type="radio" name="metode" class="w-4 h-4 text-primary-500" value="tadah" />
				...
				<div class="bg-primary-500/20 border border-primary-500/30 rounded-xl p-4">
					...
					<p class="text-white/40 text-xs mt-1">Hasil panen: 0 kg | Metode: Irigasi (5%)</p>
				</div>
